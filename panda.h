...
#define Vector(_type, _name)                                                  \
    ...
    void insert_##_name(_name* vector, size_t _idx, _type val) {              \
        if (vector->size == vector->capacity) {                               \
            vector->capacity <<= 1;                                           \
            vector->data = (_type*)realloc(vector->data,                      \
                                           vector->capacity * sizeof(_type)); \
        }                                                                     \
    ...
    void resize_##_name(_name* vector, size_t size) {                         \
        vector->data = (_type*)realloc(vector->data, size * sizeof(_type));   \
    ...
    _name* create_vector_##_name() {                                          \
        _name* vector = (_name*)malloc(sizeof(_name));                        \
        vector->size = 0;                                                     \
        vector->capacity = 16;                                                \
        vector->data = (_type*)malloc(vector->capacity * sizeof(_type));      \
